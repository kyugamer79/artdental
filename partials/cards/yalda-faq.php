...
<div class="py-6 | faq-card" id="<?php echo "faq-$postId" ?>">
    <div class="faq-toggle | flex justify-between gap-2 items-center cursor-pointer">
        <span class="text-h6 max-md:text-body_s text-primary-100">
            <?php echo '• ' . get_the_title($postId) ?>
        </span>

        <svg class="icon size-4 fill-primary-50 stroke-primary-50 text-primary-100 transition-all">
            <use href="#icon-plus"></use>
        </svg>
    </div>

    <div class="faq-expert | text-primary-80 text-body_s grid grid-rows-[0fr] transition-all duration-300">
